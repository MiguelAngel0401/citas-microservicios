...
public record MedicoRequest(
        ...
        @Size(min = 1, max = 100, message = "El email debe de tener entre 1 y 100 carcateres")
        @Email(message = "El email debe tener un formato correcto (correo@dominio)")
        String email,
        ...
        @Min(value = 1, message = "El id de especialidad debe ser positivo")
        Long idEspecialidad
) {}