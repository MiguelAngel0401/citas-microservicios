package com.miguel.pacientes.entities;

import org.hibernate.annotations.JdbcTypeCode;
import org.hibernate.type.SqlTypes;

import com.miguel.commons.enums.EstadoRegistro;
import com.miguel.commons.utils.StringCustomUtils;
import com.miguel.commons.utils.ValoresNumericosUtils;
...
public class Paciente {
    ...
    private void validarDatos(String nombre, String apellidoPaterno, String apellidoMaterno, String email,
		 ...
		 StringCustomUtils.validarTamanio(direccion, 1, 150, "La direccion es requrida y debe tener entre 1 y 50 caracteres");
		  
		  
		  
		  ValoresNumericosUtils.validarRangoShort(edad, (short)1, (short)100, "La edad es requerida y debe tener entre 1 y 100 años");
		  
		  ValoresNumericosUtils.validarRangoDouble(peso, 1.0, 200.0, "El peso es requerido y debe ser entre 1 y 200 kg");
		  
		  ValoresNumericosUtils.validarRangoDouble(estatura, 1.0, 2.0, "La estatura es requerida y debe tener entre 1 y 2 metros");
    }
